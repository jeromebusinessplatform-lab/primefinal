...
function AppFrame() {
  ...
  return (
    <div className="w-full min-h-[100dvh] flex flex-col items-center justify-start bg-neutral-950 overflow-x-hidden">
      <div className={`w-full ${isAdmin ? "max-w-[900px]" : "max-w-[412px]"} min-h-[100dvh] bg-white relative flex flex-col shadow-2xl overflow-x-hidden border-x border-neutral-800/20`}>
        <Routes>
...
export default function App() {
  return (
    <TelegramProvider><CartProvider><AdminProvider>
      ...
      <BrowserRouter><AppFrame /></BrowserRouter>
